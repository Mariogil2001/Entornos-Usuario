 ...
 * @author Daniel Breva
 * @version 1.0
 * @description: Clase que representa una coleccion de peliculas
 * 
 */
public class PeliculaModel {
    ...
    */
    ...
    @Override //sobreescribimos el método toString para que devuelva un String con todas las películas
